...
listFilename = []
id = 0
rootfolder = '/media/anlab/data-2tb/ANLAB_THUY/CVSurvey/FAKE_REAL_SNAKER_SURVEY/Data/FakeSneakers(Soda)/CharacterData/AugmentData/Augment1/Val/'
for foldername in tqdm(os.listdir(rootfolder)):
    for filename in tqdm(os.listdir(rootfolder+foldername)):
        ...
        listEmb.append(emb)
pickle.dump(np.array(listEmb), open('/media/anlab/data-2tb/ANLAB_THUY/CVSurvey/FAKE_REAL_SNAKER_SURVEY/Data/FakeSneakers(Soda)/CharacterData/AugmentData/Augment1/ValData.pickle', 'wb'))
pickle.dump(np.array(listLabel), open('/media/anlab/data-2tb/ANLAB_THUY/CVSurvey/FAKE_REAL_SNAKER_SURVEY/Data/FakeSneakers(Soda)/CharacterData/AugmentData/Augment1/ValLabel.pickle', 'wb'))
pickle.dump(np.array(listFilename), open('/media/anlab/data-2tb/ANLAB_THUY/CVSurvey/FAKE_REAL_SNAKER_SURVEY/Data/FakeSneakers(Soda)/CharacterData/AugmentData/Augment1/ValFilename.pickle', 'wb'))
